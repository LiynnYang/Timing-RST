...
parser.add_argument('--num_batched', type=int, default=80000, help='total number of the sample')
...
# pre_ckp_dir = exp_dir + 'rsmt' + str(args.degree - 1) + 'b.pt' if args.degree != 3 else None
